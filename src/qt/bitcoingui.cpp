...
{
    resize(850, 550);
    setWindowTitle(tr("WarOfCoinsX") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a WarOfCoinsX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About WarOfCoinsX"), this);
    aboutAction->setToolTip(tr("Show information about WarOfCoinsX"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for WarOfCoinsX"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("WarOfCoinsX client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("WarOfCoinsX client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WarOfCoinsX network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid WarOfCoinsX address or malformed URI parameters."));
    }
