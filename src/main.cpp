...
const string strMessageMagic = "WarOfCoinsX Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WarOfCoinsX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "WOCX is the future";
        CTransaction txNew;
        txNew.nTime = 1429704000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1429704000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2776645;
		if(fTestNet)
        {
            block.nNonce   = 47778;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5c8d49b7bdae7a6d371ff4e9499f73c2f11ce2ac53319c46450cfac66579d057"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb1, 0xa4, 0xa2, 0xa3 };
